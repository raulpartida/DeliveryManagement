 ...
 */
public class CambiarPalabraWebService {
    private static final String URL ="http://172.20.10.3/DeliveryManagementWebService/CambioPalabra";

    public OlvidoContrasena setPalabra(OlvidoContrasena olvidasteTuContrasena){
